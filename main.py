...
flags.DEFINE_enum('operation', 'get_dataset_statistics', ['get_dataset_statistics','generate_trainset_testset', 'algorithm_hyperparameter_tuning', 'check_independence_assumption'], help="Specify the operation you want to purse")
