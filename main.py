...
import compute_individual_influence
...
flags.DEFINE_enum('dataset', 'MovieLens_100k', ['sample_test', 'MovieLens_100k', 'MovieLens_1M'], help="Specify the dataset to be used in the flagfile. Dflt: 'MovieLens_100k")
...
def main(argv):
    ...
    if FLAGS.operation == 'get_dataset_statistics':
        print("Compute common statistics of the specified dataset.")
        data_preprocessing.get_dataset_statistics(FLAGS.dataset)

    elif FLAGS.operation == 'generate_trainset_testset':
        print("Generating train, test, and validation sets according to the specified ratios.")
        data_preprocessing.generate_trainset_testset(FLAGS.dataset)
        ...
        compute_ratings.compute_ratings(FLAGS.dataset, FLAGS.algorithm, num_removed_users=1)
        compute_individual_influence.compute_individual_influence(FLAGS.dataset, FLAGS.algorithm)
